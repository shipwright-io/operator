...
// +kubebuilder:rbac:groups=operator.tekton.dev,resources=tektonconfigs,verbs=get;list;create;update
...
// +kubebuilder:rbac:groups=shipwright.io,resources=builds;buildruns,verbs=get;list;watch;create;update
// +kubebuilder:rbac:groups=tekton.dev,resources=customruns,verbs=get;list;watch
// +kubebuilder:rbac:groups=tekton.dev,resources=customruns/finalizers;customruns/status,verbs=patch;update
// +kubebuilder:rbac:groups=tekton.dev,resources=pipelineruns,verbs=get;list;watch;patch;update
